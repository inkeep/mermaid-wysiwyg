...
const REPO = 'inkeep/mermaid-wysiwyg'
const REPO_URL = `https://github.com/${REPO}`
const INSTALL_CMD = 'npm i @inkeep/mermaid-wysiwyg-react'
      ...
      <main id="top">
        ...
        <section id="install" style={{ maxWidth: 1000, margin: '0 auto', padding: '64px 26px 30px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
            <CodeCard title="React — @inkeep/mermaid-wysiwyg-react">
              <span style={cmt}># npm i @inkeep/mermaid-wysiwyg-react</span>
              {'\n'}
              ...
              <span style={str}>'@inkeep/mermaid-wysiwyg-react'</span>
            ...
            <CodeCard title="CodeMirror pane — -codemirror">
              ...
              <span style={str}>'@inkeep/mermaid-wysiwyg-codemirror'</span>
              {'\n\n'}
            ...
            <CodeCard title="Monaco — -monaco">
              ...
              <span style={str}>'@inkeep/mermaid-wysiwyg-monaco'</span>
              {'\n\n'}
        ...
        <footer style={{ borderTop: '1px solid #E6E0D4', marginTop: 40 }}>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 20, fontSize: 14, marginLeft: 8, flexWrap: 'wrap' }}>
              ...
              <a href="https://www.npmjs.com/package/@inkeep/mermaid-wysiwyg-react" style={{ color: '#6B6559' }}>
                npm
              </a>
            </div>
