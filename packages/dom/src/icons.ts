/** Inline Lucide icons (https://lucide.dev, ISC) used by the popover UI. */
...
export const ICONS = {
  ...
  arrowLeftToLine: icon('<path d="M3 19V5"/><path d="m13 6-6 6 6 6"/><path d="M7 12h14"/>'),
  arrowRightToLine: icon('<path d="M17 12H3"/><path d="m11 18 6-6-6-6"/><path d="M21 5v14"/>'),
  square: icon('<rect width="18" height="18" x="3" y="3" rx="2"/>'),
  stickyNote: icon(
    '<path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11l5-5V5a2 2 0 0 0-2-2Z"/><path d="M15 21v-4a2 2 0 0 1 2-2h4"/>',
  ),
  frame: icon(
  ...
  listPlus: icon('<path d="M11 12H3"/><path d="M16 6H3"/><path d="M16 18H3"/><path d="M18 9v6"/><path d="M21 12h-6"/>'),
  braces: icon(
